...
- **Source Code**: [`gemm_inplace_transpose.cu`](./week_03/gemm_inplace_transpose.cu)  
- **Run**:  
  ```bash
...
- **Source Code**: [`gemm_tiled.cu`](./week_03/gemm_tiled.cu)  
- **Run**:  
  ```bash
...
- **Source Code**: [`online_softmax.c`](./week_03/online_softmax.c)  
- **Run**:  
  ```bash
